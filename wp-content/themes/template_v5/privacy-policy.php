            ...
            <div class="row">
                <div class="col-12">
                    <div class="terms_condition__content p-5 p-md-10 p-lg-15 bg1-color rounded-20 br2">
                        <h3 class="mb-8 mb-md-10 wow fadeInUp">All tasks and rewards are limited and will be issued based on a
                            first-come, first-served basis.</h3>
                        <p class="mb-5 mb-md-6 wow fadeInUp">Please note that all tasks and associated rewards are subject to
                        ...
                        <h3 class="mb-8 mb-md-10 wow fadeInUp">Users have to create and participate with a CoinX Wallet in order to
                            receive any rewards.</h3>
                        <p class="mb-5 mb-md-6 wow fadeInUp">Id ipsum mi tempor eget. Pretium consectetur scelerisque blandit
                        ...
                        <hr class="bg2-color my-8 my-md-10">
                        <h3 class="mb-8 mb-md-10 wow fadeInUp">CoinX reserves the right of final interpretation of all terms and
                            conditions.</h3>
                        <p class="mb-5 mb-md-6 wow fadeInUp">Id ipsum mi tempor eget. Pretium consectetur scelerisque blandit
                            habitasse non ullamcorper enim, diam quam id et, tempus massa. Sed nam vulputate
                            pellentesque quis. Varius a, nunc faucibus proin elementum id odio auctor. Nunc, suspendisse
